...
public class FileEditor extends JDialog {
    ...
    private JButton buttonClearNew;
    ...
    //    getRootPane().setDefaultButton(buttonOpen);
        ...
        buttonTopToNew.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                appendText(textAreaTop, textAreaNew);
            }
        });
        ...
        buttonBottomToNew.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                appendText(textAreaBottom, textAreaNew);
            }
        });

        buttonClearNew.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                textAreaNew.setText("");
            }
    ...
    private void appendText(JTextArea srcTextArea, JTextArea destTextArea) {
        String selectedText = srcTextArea.getSelectedText();
        if (selectedText != null && selectedText.length() > 0) {
            destTextArea.append(selectedText);
        }
        else {
            destTextArea.append(srcTextArea.getText());
        }
    }
